...
const Searchbar = ({ setGameIDs, setGameData, setTeamData, setPlayerData }) => {
    ...
    //         try {
    //             const fetchedGameDetails = await fetchGameDetails(gameIDs);
    //             setGameData(fetchedGameDetails);
    //         } catch (e) {
    //             console.error("Error fetching game details: ", e);
    //         }
    //     }
    //     // Check if gameIDs is not empty before calling getDetails
    //     if (gameIDs.length > 0) {
    //         getDetails();
    //     }
    // }, [gameIDs]);
    ...
    //                 homeTeamData[0].logo = '../../images/logos/' + homeTeamData.NICKNAME + '.png';
    //                 awayTeamData[0].logo = '../../images/logos/' + awayTeamData.NICKNAME + '.png';
    ...
    //     // Check if gameData is not empty before calling getDetails
    //     if (gameData.length > 0) {
    //         getDetails();
    //     }
    // }, [gameData]);
